...
export default function ContactSection() {
  return (
    <div className="w-full max-w-5xl mx-auto px-6 py-12 font-sans" style={{ color: 'var(--text-primary)' }}>
      <BlurFade delay={0.1}>
        <div className="flex flex-col gap-10">
          
          {/* Header Section */}
          <div className="flex flex-col items-start gap-4 max-w-2xl">
            {/* Status Badge - Updated for dark mode compatibility */}
            <div className="inline-flex items-center gap-2 bg-emerald-500/10 text-emerald-500 border border-emerald-500/20 text-xs font-medium px-3 py-1.5 rounded-full">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
            ...
            <div className="lg:col-span-8 flex flex-col gap-6">
              <h2 className="text-lg font-normal">Get in Touch</h2>
              ...
              <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <input
                    type="text"
                    placeholder="Name"
                    className="w-full border rounded-xl px-4 py-3.5 text-sm focus:outline-none transition-all placeholder:text-gray-400 dark:placeholder:text-gray-500"
                    style={{ 
                ...
                <textarea
                  ...
                  className="w-full border rounded-2xl p-4 text-sm focus:outline-none transition-all resize-none placeholder:text-gray-400 dark:placeholder:text-gray-500"
                  style={{ 
                    backgroundColor: 'var(--bg-secondary)', 
                    color: 'var(--text-primary)',
                    borderColor: 'var(--border-color)'
                ...
                <button
                  type="submit"
                  className="w-full text-sm font-medium py-3.5 rounded-xl transition-all duration-200 cursor-pointer shadow-sm active:scale-[0.99]"
                  style={{ 
            ...
            <div className="lg:col-span-4 flex flex-col gap-8">
              ...
              {/* Social Group */}
              <div className="flex flex-col gap-4">
                <h2 className="text-lg font-normal">Social</h2>
                <div className="flex flex-col gap-3 text-sm">
                  <a 
                    href="https://x.com/amieljake11" 
                    target="_blank" 
                    rel="noreferrer" 
                    className="flex items-center gap-3 transition-colors"
                    style={{ color: 'var(--text-secondary)' }}
                  ...
                  <a 
                    href="https://www.facebook.com/amieljakee" 
                    target="_blank" 
                    rel="noreferrer" 
                    className="flex items-center gap-3 transition-colors"
                    style={{ color: 'var(--text-secondary)' }}
                  ...
                  <a 
                    href="https://www.instagram.com/amieljake/" 
                    target="_blank" 
                    rel="noreferrer" 
                    className="flex items-center gap-3 transition-colors"
                    style={{ color: 'var(--text-secondary)' }}
                  ...
                  <a 
                    href="https://www.linkedin.com/in/amiel-jake-baril-316366412/" 
                    target="_blank" 
                    rel="noreferrer" 
                    className="flex items-center gap-3 transition-colors"
                    style={{ color: 'var(--text-secondary)' }}
